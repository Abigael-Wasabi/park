...
// function About({showAModal, closeAModal}) {
...
//             <span className="close" onClick={handleCloseAModal}>&times;</span>
...
// enhancing convenience, and ensuring a hassle-free journey for every driver.</h6>
...
// parking area owners plan their schedules effectively.</li></h6>
...
// especially after alighting from planes or carrying luggage.</li></h6>
...
// making parking and transportation an effortless experience for everyone.</h6><br></br>
...
<div className='col-sm-6'>
  <Link to="/logsign" style={{textDecoration: 'none', color: 'black'}}>
